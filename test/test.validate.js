...
test( 'a package option is required', function test( t ) {
	var err = validate( {}, {} );
	t.ok( err instanceof TypeError, 'package name required' );
	t.end();
});

test( 'if provided a package option which is not a primitive string, the function returns a type error', function test( t ) {
	var values;
	var err;
	var i;
